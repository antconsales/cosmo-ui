/**
 * COSMO UI - AI Demo with Claude (Anthropic)
 *
 * Test the AI-first UI generation with your Anthropic API key.
 *
 * Usage:
 *   ANTHROPIC_API_KEY=sk-ant-... pnpm demo
 */
...
async function main() {
  console.log("\n🚀 COSMO UI - AI Generation Demo (Claude)\n");

  if (!process.env.ANTHROPIC_API_KEY) {
    console.log("❌ Missing ANTHROPIC_API_KEY environment variable\n");
    console.log("Usage:");
    console.log("  ANTHROPIC_API_KEY=sk-ant-... pnpm demo\n");
    process.exit(1);
  }
